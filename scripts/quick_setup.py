...
class QuickSetup:
    ...
    def get_database_credentials(self):
        ...
        self.env_vars["DB_NAME"] = input("Database Name [u796724541_englishAppDB]: ") or "u796724541_englishAppDB"
        self.env_vars["DB_USERNAME"] = input("Database Username [u796724541_adminGMC]: ") or "u796724541_adminGMC"
    ...
    def get_test_credentials(self):
        ...
        self.env_vars["DEV_ADMIN_PASSWORD"] = getpass.getpass("Dev Admin User Password: ")
        ...
        if use_prod.lower() == 'y':
            ...
            self.env_vars["PROD_TEST_PASSWORD"] = getpass.getpass("Prod Test User Password: ")
            self.env_vars["PROD_ADMIN_USER"] = input("Prod Admin User Email: ")
            self.env_vars["PROD_ADMIN_PASSWORD"] = getpass.getpass("Prod Admin User Password: ")
        else:
    ...
    def get_jwt_secrets(self):
        ...
        if use_custom_jwt.lower() == 'y':
            self.env_vars["JWT_SECRET_PROD"] = getpass.getpass("Production JWT Secret: ")
            self.env_vars["JWT_REFRESH_SECRET_PROD"] = getpass.getpass("Production Refresh Secret: ")
        else:
    ...
    def get_oauth_credentials(self):
        ...
        if setup_oauth.lower() == 'y':
            ...
            self.env_vars["GOOGLE_CLIENT_SECRET_PROD"] = getpass.getpass("Google Client Secret: ")
            
            print("\nFacebook OAuth:")
            self.env_vars["FACEBOOK_APP_ID_PROD"] = input("Facebook App ID: ")
            self.env_vars["FACEBOOK_APP_SECRET_PROD"] = getpass.getpass("Facebook App Secret: ")
        else:
    ...
    def create_env_file(self):
        ...
        categories = {
            ...
            "Development Test Users": ["DEV_TEST_USER", "DEV_TEST_PASSWORD", "DEV_ADMIN_USER", "DEV_ADMIN_PASSWORD"],
            "Production Test Users": ["PROD_TEST_USER", "PROD_TEST_PASSWORD", "PROD_ADMIN_USER", "PROD_ADMIN_PASSWORD"],
            "JWT Secrets": ["JWT_SECRET_PROD", "JWT_REFRESH_SECRET_PROD"],
            "OAuth Configuration": ["GOOGLE_CLIENT_ID_PROD", "GOOGLE_CLIENT_SECRET_PROD", "FACEBOOK_APP_ID_PROD", "FACEBOOK_APP_SECRET_PROD"],
            "CI/CD": ["GITHUB_TOKEN", "SLACK_WEBHOOK_URL"],
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Quick setup for WordMate test automation")
