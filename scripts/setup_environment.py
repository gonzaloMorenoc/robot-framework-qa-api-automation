    ...
    def get_firefox_driver_url(self):
        ...
        try:
            ...
            for asset in release_info["assets"]:
                ...
                elif self.system == "darwin" and "macos" in name and name.endswith(".tar.gz"):
                    return asset["browser_download_url"], version
                elif self.system == "linux" and "linux" in name and name.endswith(".tar.gz"):
                    return asset["browser_download_url"], version
...
"""
    ...
    def run_setup(self, update_drivers=False, validate_only=False):
        ...
        print("  2. Run smoke tests: python scripts/run_tests.py --env dev --suite smoke")
...
def main():
    ...
    try:
        success = setup.run_setup(
            update_drivers=args.update_drivers,
